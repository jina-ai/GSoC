...
| ------------------------------------------------------------ | ----------------------------------------- | ------------------------------------------------------------ | ---------- | --------- |
| [Build Executor (model) UI in jina](https://github.com/jina-ai/GSoC/issues/16) | Python                                    | @[Alaeddine Abdessalem](https://github.com/alaeddine-13), @[Philip Vollet](https://www.linkedin.com/in/philipvollet) | Easy       | 175 hours |
| [DocArray wrap ANN libraries](https://github.com/jina-ai/GSoC/issues/17) | Python, ANN Search experience             | @[Johannes Messner](https://github.com/JohannesMessner), @[Sami Jaghouar](https://github.com/samsja), @[Philip Vollet](https://www.linkedin.com/in/philipvollet) | Medium     | 175 hours |
